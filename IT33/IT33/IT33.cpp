...
// IT33.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIT33App, CWinApp)
...
// Единственный объект CIT33App

CIT33App theApp;


// Инициализация CIT33App

BOOL CIT33App::InitInstance()
{
